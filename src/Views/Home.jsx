  ...
  return (
    <div className='container-home'>
      ...
      <div className='home-text'>
        {width > 1000 ? (
          mount ? (
            <h3 onMouseLeave={handleMount} onClick={() => navigate("/about")}>
              About
            </h3>
          ) : (
        ...
        {type ? (
          <p>
            ...
            <Typical
              ...
              wrapper='b'
              steps={[
                `${width > 1000 ? "Hover" : "Touch"} over ${
                  width > 1000 ? "Hello" : "Start"
                }`,
                2000,
          ...
          <p>
            <Typical wrapper='b' steps={["Welcome to my Website", 1000]} />
          </p>
        )}
      </div>
      <aside className='home-social'>
        <ul>
          <li>
            <a
              href={Data.personal.social.facebook}
              target='_blank'
              rel='noreferrer'
          ...
          <li>
            <a
              href={Data.personal.social.YouTuBe}
              target='_blank'
              rel='noreferrer'
